...
module OcfParser 
  ...
  class Metadata
    ...
    CONTENT_NODE_LIST = ['author', 'authordescription', 'bookname', 'isbn',
      'publisherdate','shortdescription', 'longdescription', 'format','publisher','actualbook','source','keyword','secondsort'].each {
      |node|
